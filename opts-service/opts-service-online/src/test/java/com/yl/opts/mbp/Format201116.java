...
public class Format201116 {
    ...
    public static void main(String[] args) {
        ...
        String text = "db.getCollection(\"lk_book_user_share_log\").insert( {\n" +
                "   \n" +
                "    merchantId: NumberInt(\"-1\"),\n" +
                "    moduleId: NumberInt(\"2\"),\n" +
                "    chapterId: NumberInt(\"%s\"),\n" +
                "    type: NumberInt(\"1\"),\n" +
                "    createTime: new Date(),\n" +
                "    freeMode: NumberInt(\"0\"),\n" +
                "    count: NumberInt(\"%s\"),\n" +
                "    updateTime: new Date(),\n" +
                "\t\tfreeModelLimit: NumberInt(\"0\")\n" +
                "} );\n";
